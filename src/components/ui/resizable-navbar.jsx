...
export const MobileNav = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center self-start justify-between rounded-full px-0 py-2 md:hidden text-neutral-200",
        visible && "bg-gray-900",
        className
      )}>
      {children}
